...
/// <summary>
/// Settings for one retry + circuit breaker + timeout pipeline, validated at startup. Ranges mirror Polly's own
/// limits so a bad value fails the host rather than the first request. One sealed subclass per dependency binds
/// its own configuration section.
/// </summary>
public abstract class ResiliencePipelineOptions
{
