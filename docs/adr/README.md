...
| [0021](0021-aks-with-workload-identity-and-sdk-container-images.md) | AKS with workload identity, SDK-built container images and Kustomize manifests | Accepted |
